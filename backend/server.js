...
app.get('/api/health', (req, res) => res.json({ status: 'ok', mongo: mongoose.connection.readyState, version: '3.0' }));
app.get('*', (req, res) => res.sendFile(path.join(__dirname, '../frontend/index.html')));
const startServer = () => app.listen(PORT, '0.0.0.0', () => console.log(`Functional Workouts v3.0 on port ${PORT}`));
